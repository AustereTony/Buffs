...
public class PotionAdvancedClimbing extends Item {
	...
	public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer player) {	
		...
		if (!eLivingBase.isBuffActive(Buff.potionCooldown.id)) {
			...
			eLivingBase.addBuff(new ActiveBuff(Buff.advancedClimbing.id, itemStack.getItemDamage(), itemStack.getItemDamage() == 0 ? 1200 : (itemStack.getItemDamage() == 1 ? 1800 : 2400)));
